...
'EHC_HC' analyzes the habitat complexity model.

'EHC_EHC' analyzes the edible habitat complexity model. 

Please feel free to reach out with any further questions: Eden.Forbes@uvm.edu
